                        ...
                        >
                          {products.map((product) => (
                            <li key={product.id} className="flex py-6">
                              ...
                              <div className="h-28 w-28 rounded-md border border-gray-200">
                                <img
                              ...
                              <div className="ml-4 flex flex-1 flex-col">
                                ...
                                <div className="flex flex-1 items-end justify-between text-sm">
                                  ...
                                  <div className="flex">
                                    <button class="flex text-white bg-indigo-500 border-0 py-2 px-2 focus:outline-none hover:bg-indigo-600 rounded text-base">
                                      View Details
                                    </button>
                                  </div>
                                </div>
